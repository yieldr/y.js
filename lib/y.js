...
(function (window) {
    ...
    y.hijack = function () {
        for (var i = 0, len = y.hj.length; i < len; i++) {
            var link = document.getElementById(y.hj[i]),
                href = (link.href.indexOf("http") === 0) ? link.href : document.location.href + link.href;
            link.href = "//y.254a.com/hijack?" + escape(href);
        };
    }
