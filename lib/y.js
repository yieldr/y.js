...
(function(y) {
  ...
  function track() {
    var console = window.console,
      ...
      server = ((document.location.protocol === 'https:') ? 'https:' : 'http:') + '//y.254a.com/pixel',
      referrer = document.referrer,
      data = y.data,
      params = getQueryParams(href);

    fire(server, data, params);
    setInterval(function() { fire(server, data, params); }, 10000);
  }
